...
<body>
    ...
    $(document).ready(function() {
        ...
        $("#contact-form").submit(function(e) {
            ...
            $.ajax({
                url: "shared/processRequest.php", // PHP file that processes the form
                type: "POST",
                data: formData,
    ...
    var swiper = new Swiper('.testimonial-swiper', {
        ...
        autoplay: {
            delay: 2000,
            disableOnInteraction: false, // Changed to false so it continues after interaction
        },
        speed: 1000,
        slidesPerView: 'auto',
        spaceBetween: 20,
        ...
        pagination: {
            ...
            clickable: true, // Changed to true to allow clicking on pagination
        },
        grabCursor: true, // Added to show grab cursor
        effect: 'slide',
    });
    </script>
