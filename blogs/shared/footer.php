<footer id="footer" class="bg-black text-white py-5">
    <div class="container-sm">
        ...
        <div class="col-md-4">
            <div class="info-box">
            <img src="../images/name-logo-2.png" class="img-fluid" height="300px" width="300px" style="margin-top: -50px">
        ...
        <div class="col-md-3">
            ...
            <div class="col-6">
                ...
                <li>
                    <a class="text-decoration-none text-white" href="../index.php#services-section">Services</a>
                </li>
                </ul>
            </div>
            <div class="col-6">
